...
typedef NS_ENUM(NSInteger, HLRGBROW){
    HLRGBROWRed,
    HLRGBROWGreen,
    HLRGBROWBlue
};

@interface HLTestViewController () <UITableViewDataSource,UITableViewDelegate>
...
{
    NSString *tempString = _datas[sourceIndexPath.row];
    [_datas removeObjectAtIndex:sourceIndexPath.row];
    [_datas insertObject:tempString atIndex:destinationIndexPath.row];
    [_tableView reloadData];
}
